...
require_relative "lib/eveveneno_palindrome//version"

Gem::Specification.new do |spec|
  spec.name = "eveveneno_palindrome"
  spec.version = EvevenenoPalindrome::VERSION
  spec.authors = ["Evelyn R"]
  spec.email = ["evelynrodriguezc0@gmail.com"]

  spec.summary = "Palindrome detector"
  spec.description = "Learn Enough Ruby palindrome detector"
  spec.homepage = "https://github.com/evelynrodriguezc/eveveneno_palindrome"
